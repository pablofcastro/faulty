...
public class PWW extends Permission {
	
	private FormulaElement expr3;
	private FormulaElement expr4;
	
	public PWW(String op,FormulaElement e1, FormulaElement e2, FormulaElement e3, FormulaElement e4){
	    super(op, e1, e2);
	    expr3 = e3;
	    expr4 = e4;
	}
     ...
     *      
     * If formula = P( f1 U f2 ~> f3 U f4), returns f4;     
     */
