...
public class tests_obligations {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------------- Property : O ( X p -> X q)) -----------------------------------\n");		
				
		FormulaElement form1 = new OXX("O",vp, vq); // Sat = 0100, 0101, 1100, 1000, 1111 y 0010  
		...
		FormulaElement form2 = new OXU("O",vp, nq,vs); 
		...
		FormulaElement form3 = new OXU("O",p_or_q, nq, s_or_q); 
		...
		FormulaElement form4 = new OUX("O",ns, vq, p_or_q); 
		...
		FormulaElement form5 = new OUU("O",ns, vq, ns, vq); 
