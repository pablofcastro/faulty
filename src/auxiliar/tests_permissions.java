...
public class tests_permissions {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------------- Property : P ( X p -> X q)) -----------------------------------\n");		
		
				
		FormulaElement form1 = new PXX("P",vp, vq); // Sat = 0100, 0101, 1100, 1000, 1111 y 0010  
        ...
        System.out.println("--------------------------- Property : P ( X p -> !q U s)) -----------------------------------\n");		
		
		FormulaElement form2 = new PXU("P",vp, nq,vs);		                                       
		...
		System.out.println("--------------------------- Property : P ( X (p or q) -> !q U (s or q)) -----------------------------------\n");		
	
		
		FormulaElement form3 = new PXU("P",p_or_q, nq, s_or_q); 
		...
		System.out.println("--------------------------- Property : P ( !s U q -> X (p or q)) -----------------------------------\n");		

		
		FormulaElement form4 = new PUX("P",ns, vq, p_or_q); 
		...
		System.out.println("--------------------------- Property : P ( !s U q -> !s U q) -----------------------------------\n");		

		
		FormulaElement form5 = new PUU("P",ns, vq, ns, vq); 
