...
public class tests_forAll {
	...
	public static void main(String[] args) {
		...
		FormulaElement vr= new Variable("r");
		FormulaElement nq= new Negation("!", vq);
		FormulaElement nr= new Negation("!", vr);
		...
		//-------------------------------
		// tests for standard formulas
		//-------------------------------
		
		FormulaElement form6 = new AU("AU",vp, vq); // A(pUq) should be false..
		System.out.println("--------------------------- Property : A(pUq) -----------------------------------\n");	
		...
		FormulaElement form7 = new EU("EU",vp, vq); // E(pUq) must be false, p is not true at the init...
		System.out.println("--------------------------- Property : E(pUq) -----------------------------------\n");	
		...
		FormulaElement form8 = new EU("EU",np, vp); // E(!pUp) must be true
		System.out.println("--------------------------- Property : E(!pUp) -----------------------------------\n");	
		if (DCTL_MC.mc_algorithm(form8, m)) {
			System.out.println("Property is TRUE in the model.");
		}
		else{
			System.out.println("Property is FALSE in the model.");
		...
		FormulaElement form9 = new AW("AW", vr, ff); // A(rWr) must be true
		System.out.println("--------------------------- Property : AW(rUff) -----------------------------------\n");	
		if (DCTL_MC.mc_algorithm(form9, m)) {
			System.out.println("Property is TRUE in the model.");
		}
		else{
			System.out.println("Property is FALSE in the model.");
		...
		FormulaElement form10 = new EW("AU", vr, ff); // A(ttUtt) must be true
		System.out.println("--------------------------- Property : AW(rUff) -----------------------------------\n");	
		LinkedList<BDD> list = new LinkedList<BDD>();
		list.add(B1.ithVar(2));
		if (DCTL_MC.fair_mc_algorithm(form10, m, list)) {
			System.out.println("Property is TRUE in the model.");
		}
		else{
			System.out.println("Property is FALSE in the model.");
