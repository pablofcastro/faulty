...
public class Process{
    ...
    */
    public Process(String name, String instName, int numberVar, int numberChan, int numberBranch, int numberInst, BDDModel model){
        this.name = name;
    ...
    public Process duplicate(String instName){
    	Process result = new Process(name, instName, numberVar, numberBranch, numberChan, numberInst+1, model, disabledBlocking);
    	// we use hash mapping to record the ducplicates of each one oand to obtain the branches, expression
    	// and code
